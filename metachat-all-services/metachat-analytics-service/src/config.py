...
class Config(BaseSettings):
    ...
    def __init__(self, **kwargs):
        ...
        if yaml_config:
            ...
            kwargs.setdefault("database_url", database_config.get("url", "postgresql+asyncpg://metachat:metachat_password@localhost:5432/metachat_analytics"))
    ...
    database_url: str = "postgresql+asyncpg://metachat:metachat_password@localhost:5432/metachat_analytics"
