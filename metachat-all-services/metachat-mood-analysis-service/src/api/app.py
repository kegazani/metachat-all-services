...
async def lifespan(app: FastAPI):
    ...
    logger.info("Starting Mood Analysis Service", service_name="mood-analysis-service")
    ...
    logger.info("Mood Analysis Service started successfully")
    ...
    kafka_producer.stop()
    await db.close()
    logger.info("Mood Analysis Service stopped")
