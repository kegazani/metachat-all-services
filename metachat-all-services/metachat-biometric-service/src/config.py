...
class Config(BaseSettings):
    ...
    def __init__(self, **kwargs):
        ...
        if yaml_config:
            ...
            kwargs.setdefault("database_url", database_config.get("url", "postgresql+asyncpg://metachat:metachat_password@localhost:5432/metachat_biometric"))
            ...
            kwargs.setdefault("watch_data_received_topic", topics.get("watch_data_received", "metachat.watch.data.received"))
            kwargs.setdefault("user_health_updated_topic", topics.get("user_health_updated", "metachat.user.health.updated"))
    ...
    database_url: str = "postgresql+asyncpg://metachat:metachat_password@localhost:5432/metachat_biometric"
    database_pool_size: int = 10
    database_max_overflow: int = 20
    
    kafka_brokers: List[str] = ["localhost:9092"]
    biometric_data_received_topic: str = "metachat.biometric.data.received"
    watch_data_received_topic: str = "metachat.watch.data.received"
    user_health_updated_topic: str = "metachat.user.health.updated"
    ...
    all_kafka_topics: dict = {
        ...
        "biometric_service": [
            ...
            "metachat.watch.data.received",
            "metachat.user.health.updated"
        ],
        "correlation_service": [
            "metachat.mood.analyzed",
            "metachat.biometric.data.received",
