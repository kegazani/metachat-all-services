...
# Setup local development with replace directives

set -e

echo "Setting up local development environment..."

# Update user-service go.mod with replace directives
echo "Updating user-service go.mod..."
...
# Update diary-service go.mod with replace directives
echo "Updating diary-service go.mod..."
cat > services/diary-service/go.mod << 'EOF'
...
# Update api-gateway go.mod with replace directives
echo "Updating api-gateway go.mod..."
...
echo "You can now run 'go mod tidy' in each service directory."